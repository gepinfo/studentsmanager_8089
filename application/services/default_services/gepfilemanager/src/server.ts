...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_studentsmanager_8089;
            let db_auth = result.data.DB_AUTH_studentsmanager_8089;
            let db_coll = result.data.DB_COLL_studentsmanager_8089;
